...
public class SQLiteFirebaseQueue extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        Log.d("MCCArchers", " * * *  CREATING FIREBASE QUEUE DATABASE  * * * ");
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        Log.d("MCCArchers", " * * * * * *  FIREBASE QUEUE DATABASE VERSION CHANGE  * * * * * * * ");
        this.onCreate(db);
    } //onUpgrade
    ...
    public FirebaseQueueItem getNextQueueItem() {
        ...
        if ((cursor != null) && (cursor.getCount() == 1)) {
            ...
            try {
                ...
                e.printStackTrace();
                Log.e("MCCArchers", "error reading JSON Object from Firebase SQLite Queue");
            }
            ...
            Log.d("MCCArchers", "Found Item in FirebaseQueue : item no " + cursor.getInt(0) + ".  REF : " + cursor.getString(1) + ", JSON: " + myItem);
            return queueItem;
        } else {
            return null;
        }
