...
public class RoundScores extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try {
            ...
            if (roundJSON.has("numArrowsPerEnd"))
        ...
        headerText3.setText(roundOwner);
        ...
        for (int j = 0; j < numEnds; j++) {
            ...
            for (int i = 0; i < numArrowsPerEnd; i++) {
                ...
                alArrows.get(i).setId(200 + (j * numArrowsPerEnd) + i);
        ...
        try {
            ...
            for (int i = 0; i < endsArr.length(); i++) {
                ...
                for (int j = 0; j < arrowsArr.length(); j++) {
                    ...
                    if (tempArrow == -1) {
                        arrowTextView = (TextView) rootView.findViewById(200 + (i * numArrowsPerEnd) + j);
                        ...
                        if (arrowTextView != null) {
                            ...
                            Log.d("MCCArchers", "could not write arrow: " + i + ", " + j + "   " + 200 + (i * numArrowsPerEnd) + j);
                        }
                    }
                }
                TextView endTextView = (TextView) rootView.findViewById(400 + i);
                endTextView.setText("" + endTotal);
                TextView totalTextView = (TextView) rootView.findViewById(600 + i);
    ...
    public void DeleteSelectedRound() {
        ...
        //ToDo : BUG : Test Delete Round Feature
    } //DeleteSelectedRound
